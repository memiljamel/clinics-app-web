const btnPasswordList = [].slice.call(
  document.querySelectorAll('[data-te-container="toggle-password"]')
);

const inputPasswordList = [].slice.call(
  document.querySelectorAll('input[type="password"]')
);

btnPasswordList.map((btnPasswordItem, index) => {
  btnPasswordItem.addEventListener('click', () => {
    if (inputPasswordList[index].type === 'password') {
      inputPasswordList[index].type = 'text';

      btnPasswordItem.innerHTML = `
