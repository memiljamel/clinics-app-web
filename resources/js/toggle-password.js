...
btnTogglePasswordList.map((btnTogglePasswordItem) => {
  const inputPassword = btnTogglePasswordItem.parentElement.querySelector('input[type="password"]');

  btnTogglePasswordItem.addEventListener('click', (event) => {
    if (inputPassword.getAttribute('type') === 'password') {
      inputPassword.setAttribute('type', 'text');
      btnTogglePasswordItem.innerHTML = `
