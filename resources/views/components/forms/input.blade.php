<div class="block p-0 m-0 relative">
  <div class="block w-full min-w-[280px] h-11 p-0 mb-2 relative">
    ...
    @if ($attributes->get('type') === 'password')
      <button class="block w-10 h-10 p-2 m-0 text-black/[0.60] rounded-full align-middle cursor-pointer outline-none transition duration-150 ease-in-out absolute right-0 top-1/2 -translate-y-1/2 hover:bg-black/[0.04] active:bg-black/[0.10] focus:bg-black/[0.12] dark:text-white/[0.60] dark:hover:bg-white/[0.04] dark:active:bg-white/[0.10] dark:focus:bg-white/[0.12]" type="button" name="visibility">
